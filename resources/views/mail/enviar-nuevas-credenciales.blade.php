    ...
    <div class="relative flex items-top justify-center bg-gray-100 sm:items-center py-4 sm:pt-0">
        <div class="mx-auto sm:px-6 lg:px-12">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <img src="https://firebasestorage.googleapis.com/v0/b/aquacheck-bb7ee.appspot.com/o/logo-aquacheck.png?alt=media&token=728dec51-1556-4b9a-94ca-025bdeea15fa"  alt="Logo Aquacheck" >
            </div>
                ...
                <div class="grid grid-cols-3 md:grid-cols-12">
                    <div class="p-6">
                        <div class="flex items-center">
                            <div class="text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white"> Hola,   {{ $name }} </a></div>
                        </div>
